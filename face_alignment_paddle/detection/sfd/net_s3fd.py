...
class L2Norm(nn.Layer):
    def __init__(self, n_channels, scale=1.0):
        ...
        self.scale = scale
        self.eps = 1e-10
        # self.weight = nn.Parameter(paddle.Tensor(self.n_channels))
        t = paddle.to_tensor(self.n_channels)
        t *= 0.0
        t += self.scale
        self.weight = self.create_parameter(t.shape, 
                                          default_initializer=paddle.nn.initializer.Assign(t))
        # self.weight *= 0.0
